...
/**
 * UserGiftController implements the CRUD actions for UserGift model.
 *
 * @package admin\controllers
 */
final class UserGiftController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Displays a single UserGift model.
     *
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(UserGiftSearch::class)),
    ...
    /**
     * Updates an existing UserGift model.
     *
    ...
    /**
     * Deletes an existing UserGift model.
     *
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): UserGift
    {
        if (($model = UserGift::findOne($id)) !== null) {
            return $model;
        }
